        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          >
            <div className="inline-flex items-center gap-4 mb-6">
              ...
              <span className="text-accent text-xs tracking-[0.4em] uppercase font-medium">Core Principles</span>
              <div className="h-px w-8 bg-accent/50" />
            </div>
            <h2 className="font-display text-4xl md:text-7xl tracking-wider mb-6">
              OUR VALUES
            </h2>
            <p className="text-muted max-w-2xl mx-auto text-lg">
              The foundational principles that drive our creative process and client partnerships.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, i) => (
              ...
              >
                ...
                <div className="absolute inset-0 bg-card/50 backdrop-blur-sm border border-border/50 group-hover:border-accent/30 transition-all duration-500" />
                ...
                <div className="relative p-10 flex flex-col items-center text-center h-full">
                  {/* Index Number */}
                  <span className="absolute top-6 right-8 font-mono text-[10px] text-muted/30 tracking-widest group-hover:text-accent/40 transition-colors">
                    0{i + 1}
                  </span>
                  ...
                  <div className="relative mb-8">
                    ...
                    <div className="w-16 h-16 rounded-full border border-border/50 flex items-center justify-center group-hover:border-accent/50 group-hover:bg-accent/5 transition-all duration-500">
                      <value.icon className="w-7 h-7 text-muted group-hover:text-accent transition-colors duration-500" />
                    </div>
                  </div>

                  <h3 className="font-display text-2xl tracking-widest mb-4 group-hover:text-foreground transition-colors">
                    {value.title.toUpperCase()}
                  </h3>
                  
                  <p className="text-muted text-sm leading-relaxed group-hover:text-muted/80 transition-colors">
                    {value.desc}
                  </p>

                  {/* Bottom Decorative Line */}
                  <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-0 h-0.5 bg-accent group-hover:w-1/3 transition-all duration-500" />
                </div>

                {/* Corner Accents */}
                <div className="absolute top-0 left-0 w-2 h-2 border-t border-l border-border/30 group-hover:border-accent/50 transition-colors" />
                <div className="absolute top-0 right-0 w-2 h-2 border-t border-r border-border/30 group-hover:border-accent/50 transition-colors" />
                <div className="absolute bottom-0 left-0 w-2 h-2 border-b border-l border-border/30 group-hover:border-accent/50 transition-colors" />
                <div className="absolute bottom-0 right-0 w-2 h-2 border-b border-r border-border/30 group-hover:border-accent/50 transition-colors" />
              </motion.div>
            ))}
          </div>
        </div>
